...
das <- data.table("Country" = c("China", "Germany", "South Korea", "Turkey", "United States"),
                  "2015 GDP" = dat$NY.GDP.PCAP.KD.ZG[dat$year == "2015"],
                  "2016 GDP" = dat$NY.GDP.PCAP.KD.ZG[dat$year == "2016"],
                  "2017 GDP" = dat$NY.GDP.PCAP.KD.ZG[dat$year == "2017"],
                  "2018 GDP" = dat$NY.GDP.PCAP.KD.ZG[dat$year == "2018"],
                  "2019 GDP" = dat$NY.GDP.PCAP.KD.ZG[dat$year == "2019"],
                  "2020 GDP" = dat$NY.GDP.PCAP.KD.ZG[dat$year == "2020"])
